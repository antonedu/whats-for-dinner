...
import Dish from "./DishClass.js"; // FIXME: Change copying to use structuredClone instead of current implementation with slice and Object.assign
...
export function editDishes(_ref) {
  let {
    dishes,
    name,
    weekdays,
...
function dishFromObject(obj) {
  ...
  return new Dish({
    ...
    freq: obj.freq,
    id: obj.id,
    lastSeen: new ISODate(obj.lastSeen)
  });
}
