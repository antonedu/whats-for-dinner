...
import { setCookies, editDishes, removeFromDishes, loadStoredDishes, resetMenu, loadStoredMenu, hasActivatedCookies, generateNextX, extendMenu } from '../dishesFunctions.js';
  ...
  render() {
    ...
    if (this.state.content == "Dishes") {
      ...
      renderedOutput = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(MenuList, {
        ...
        onShowMore: () => {
          this.setState({
            menu: extendMenu(this.state.dishes, this.state.menu, 7)
          });
        }
      }));
